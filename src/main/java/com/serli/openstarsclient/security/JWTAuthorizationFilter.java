...
import com.serli.openstarsclient.data.Actor;
...
public class JWTAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    protected void doFilterInternal(HttpServletRequest req,
        ...
        try {
            ...
            res.setHeader("X-RESPONSE-ERROR", e.getMessage());
        }
    }
    ...
    private UsernamePasswordAuthenticationToken getAuthentication(HttpServletRequest request) {
        ...
        if (token != null) {
            ...
            if (user != null) {
                User applicationUser = userRepository.findByEmail(user);
                return new UsernamePasswordAuthenticationToken(new Actor(applicationUser), null, new ArrayList<>());
            }
            return null;
        }
        return null;
